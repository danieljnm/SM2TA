...
public class TranslatorTest {
  ...
  public void timeoutTransition() {
    ...
    _builder.append("}");
    _builder.newLine();
    _builder.append("process gen_sync_finish {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("state");
    _builder.newLine();
    ...
    _builder.append("}");
    _builder.newLine();
    _builder.append("system test, gen_sync_finish;");
    _builder.newLine();
    final String uppaal = _builder.toString();
    Assertions.assertEquals(uppaal, this.stateMachine.toUppaal());
  }
